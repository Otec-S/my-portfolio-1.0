    ...
    <section className="about-me">
      ...
      <div className="about-me__info">
        <div className="about-me__description">
          ...
          Читаю Habr и книги про Java Scrypt, привык анализировать большое количество информации, постоянно обучаюсь, имею высшую степень самоорганизованности, разговариваю с бизнесом "на одном языке". <br/><br/>
